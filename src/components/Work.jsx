      ...
      function imagesShow (arr){
        ...
        switch (Math.floor(data * 100)) {
            ...
            case 3:
                ...
                break;
            case 6:
                imagesShow([0, 1, 3, 4, 5]);
                break;
            case 8:
                imagesShow([0, 1, 3, 4, 5, 6]);
                break;
        }
        ...
        <div className='w-full mt-10 '>
            <div className='relative max-w-screen-xl mx-auto text-center'>
                ...
                <div className='w-full h-full absolute top-0 '>
                    {images.map((elem, index) => (elem.isActive && (<img key={index} className='absolute w-60 rounded-lg -translate-x-[50%] -translate-y-[50%]' style={{ top: elem.top, left: elem.left }} src={elem.url} alt="" />)))}
                </div>
            </div>
        </div>
    )
